...
#命令配置：
#查找参数：
search_mode_list = ["m", "萌", "萌娘", "萌百", "萌娘百科", "鸡", "小鸡", "小鸡词典", "c", "中国搜索", "百", "百度", "百度搜索", "searXNG", "搜索"]
#查找链接配置：
...
async def web_search(app: Ariadne, member: Member, group: Group, message: MessageChain, search_mode: RegexResult, search_string: RegexResult):
